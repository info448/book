...
<p class="alert alert-info">The code for this tutorial can be found at <https://github.com/info448/lab-multitouch>. Note that the starter code builds on the example presented in [Lecture 15](#graphics).</p>
